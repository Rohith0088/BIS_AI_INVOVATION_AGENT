...
export const FeedbackSupportModal: React.FC<FeedbackSupportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#152031] border border-white/10 rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-fadeIn max-h-[90vh] overflow-y-auto chat-scroll stitch-modal">
        {/* Header */}
